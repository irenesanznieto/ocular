...
;//! \htmlinclude Features2D.msg.html

(cl:defclass <Features2D> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass Features2D (<Features2D>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Features2D>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Features2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name TFG-msg:<Features2D> is deprecated: use TFG-msg:Features2D instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Features2D>))
...
(cl:defmethod user_id-val ((m <Features2D>))
...
(cl:defmethod name-val ((m <Features2D>))
...
(cl:defmethod descriptors-val ((m <Features2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader TFG-msg:descriptors-val is deprecated.  Use TFG-msg:descriptors instead.")
  (descriptors m))

(cl:ensure-generic-function 'keypoints-val :lambda-list '(m))
(cl:defmethod keypoints-val ((m <Features2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader TFG-msg:keypoints-val is deprecated.  Use TFG-msg:keypoints instead.")
  (keypoints m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Features2D>) ostream)
  "Serializes a message object of type '<Features2D>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Features2D>) istream)
  "Deserializes a message object of type '<Features2D>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Features2D>)))
  "Returns string type for a message object of type '<Features2D>"
  "TFG/Features2D")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Features2D)))
  "Returns string type for a message object of type 'Features2D"
  "TFG/Features2D")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Features2D>)))
  "Returns md5sum for a message object of type '<Features2D>"
  "9ea5e5e3ee33e1eb0fc171ce5ad4a203")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Features2D)))
  "Returns md5sum for a message object of type 'Features2D"
  "9ea5e5e3ee33e1eb0fc171ce5ad4a203")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Features2D>)))
  "Returns full string definition for message of type '<Features2D>"
  (cl:format cl:nil "Header header~%int32 user_id~%string[] name~%std_msgs/Float32MultiArray[] descriptors~%std_msgs/Float32MultiArray[] keypoints~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: std_msgs/Float32MultiArray~%# Please look at the MultiArrayLayout message definition for~%# documentation on all multiarrays.~%~%MultiArrayLayout  layout        # specification of data layout~%float32[]         data          # array of data~%~%~%================================================================================~%MSG: std_msgs/MultiArrayLayout~%# The multiarray declares a generic multi-dimensional array of a~%# particular data type.  Dimensions are ordered from outer most~%# to inner most.~%~%MultiArrayDimension[] dim # Array of dimension properties~%uint32 data_offset        # padding bytes at front of data~%~%# Accessors should ALWAYS be written in terms of dimension stride~%# and specified outer-most dimension first.~%# ~%# multiarray(i,j,k) = data[data_offset + dim_stride[1]*i + dim_stride[2]*j + k]~%#~%# A standard, 3-channel 640x480 image with interleaved color channels~%# would be specified as:~%#~%# dim[0].label  = \"height\"~%# dim[0].size   = 480~%# dim[0].stride = 3*640*480 = 921600  (note dim[0] stride is just size of image)~%# dim[1].label  = \"width\"~%# dim[1].size   = 640~%# dim[1].stride = 3*640 = 1920~%# dim[2].label  = \"channel\"~%# dim[2].size   = 3~%# dim[2].stride = 3~%#~%# multiarray(i,j,k) refers to the ith row, jth column, and kth channel.~%================================================================================~%MSG: std_msgs/MultiArrayDimension~%string label   # label of given dimension~%uint32 size    # size of given dimension (in type units)~%uint32 stride  # stride of given dimension~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Features2D)))
  "Returns full string definition for message of type 'Features2D"
  (cl:format cl:nil "Header header~%int32 user_id~%string[] name~%std_msgs/Float32MultiArray[] descriptors~%std_msgs/Float32MultiArray[] keypoints~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: std_msgs/Float32MultiArray~%# Please look at the MultiArrayLayout message definition for~%# documentation on all multiarrays.~%~%MultiArrayLayout  layout        # specification of data layout~%float32[]         data          # array of data~%~%~%================================================================================~%MSG: std_msgs/MultiArrayLayout~%# The multiarray declares a generic multi-dimensional array of a~%# particular data type.  Dimensions are ordered from outer most~%# to inner most.~%~%MultiArrayDimension[] dim # Array of dimension properties~%uint32 data_offset        # padding bytes at front of data~%~%# Accessors should ALWAYS be written in terms of dimension stride~%# and specified outer-most dimension first.~%# ~%# multiarray(i,j,k) = data[data_offset + dim_stride[1]*i + dim_stride[2]*j + k]~%#~%# A standard, 3-channel 640x480 image with interleaved color channels~%# would be specified as:~%#~%# dim[0].label  = \"height\"~%# dim[0].size   = 480~%# dim[0].stride = 3*640*480 = 921600  (note dim[0] stride is just size of image)~%# dim[1].label  = \"width\"~%# dim[1].size   = 640~%# dim[1].stride = 3*640 = 1920~%# dim[2].label  = \"channel\"~%# dim[2].size   = 3~%# dim[2].stride = 3~%#~%# multiarray(i,j,k) refers to the ith row, jth column, and kth channel.~%================================================================================~%MSG: std_msgs/MultiArrayDimension~%string label   # label of given dimension~%uint32 size    # size of given dimension (in type units)~%uint32 stride  # stride of given dimension~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Features2D>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Features2D>))
