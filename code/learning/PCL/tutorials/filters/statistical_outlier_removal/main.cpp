...
main (int argc, char** argv)
{
  ...
  reader.read<pcl::PointXYZ> ("../data/table_scene_lms400.pcd", *cloud); //reading from bin directory
  ...
  writer.write<pcl::PointXYZ> ("../data/table_scene_lms400_outliers.pcd", *cloud_filtered, false);
	...
	pcl::visualization::CloudViewer viewer("clouds");
  	viewer.showCloud(cloud, "original cloud");
  	viewer.showCloud(cloud_filtered, "modified cloud");
