...
{
    point_cloud_sub= nh.subscribe <sensor_msgs::PointCloud2> ("input", 1, &RoiSegmenter3DNode::original_pc_cb, this);
...
void RoiSegmenter3DNode :: original_pc_cb (const sensor_msgs::PointCloud2ConstPtr &msg)
{
