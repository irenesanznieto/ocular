"""autogenerated by genpy from TFG/HandPointCloud.msg. Do not edit."""
import sys
...
class HandPointCloud(genpy.Message):
  _md5sum = "899f5cab835230d85f28f09b38d4247b"
  _type = "TFG/HandPointCloud"
...
"""
  __slots__ = ['header','name','pointcloud']
  _slot_types = ['std_msgs/Header','string','sensor_msgs/PointCloud2']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HandPointCloud, self).__init__(*args, **kwds)
